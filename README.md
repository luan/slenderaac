...
Edit `.env` with your server and desired settings. Then migrate the database using the command below. You can run this before or after importing `canary`'s schema.
